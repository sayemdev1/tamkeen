<?php
use App\Http\Controllers\PyramidReferralController;
use App\Http\Controllers\ReferralNewController;
...
//
Route::post('/apply-referral-code/{membershipLevelId}', [PyramidReferralController::class, 'applyReferralCode']);



Route::get('products/{product}', [ProductController::class, 'show']);
Route::get('product-all', [ProductController::class, 'all']);
Route::get('membership-levels/{membershipLevel}/get-details', [MembershipLevelController::class, 'getDetails']);
Route::get('pyramid/referral-tree/{userId}', [PyramidReferralController::class, 'viewReferralTree']);
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::resource('productsWithFile', ProductController2::class)->except(['show']);

    Route::post('membership-levels/{membershipLevel}/subscribe', [MembershipLevelController::class, 'subscribe']);
    Route::post('membership-levels/{membershipLevel}/subscribe-new', [MembershipLevelController::class, 'processReferralSubscription']);
    Route::post('/subscribe/{membershipLevelId}', [ReferralNewController::class, 'subscribe']);
    
    Route::post('/pyramid/subscribe/{membershipLevelId}', [PyramidReferralController::class, 'subscribe']);
    Route::get('/pyramid/user-profits/{userId}', [PyramidReferralController::class, 'viewUserProfits']);
    Route::get('/pyramid/user-memberships/{userId}', [PyramidReferralController::class, 'viewUserMemberships']);
    Route::get('/pyramid/admin/all-users-profits', [PyramidReferralController::class, 'viewAllUsersProfits']);
    Route::get('/pyramid/referral-levels/{userId}', [PyramidReferralController::class, 'viewReferralLevels']);

    
    Route::get('/referral-tree/{userId}', [ReferralNewController::class, 'viewReferralTree']);
    Route::get('/user-profits/{userId}', [ReferralNewController::class, 'viewUserProfits']);
    Route::get('/admin/all-users-profits', [ReferralNewController::class, 'viewAllUsersProfits']);
    ...
    Route::delete('/packages/{packageId}/{storeId?}', [PackageController::class, 'destroy']);  // Delete a package



    Route::get('getReferralsWithProfits/{userId?}', [ReferralController::class, 'getReferralsWithProfits']);
    Route::resource('/admin-packages', PackageController::class)->except('store');
...
Route::put('packages/{packageId}/{storeId?}', [PackageController::class, 'update']);
